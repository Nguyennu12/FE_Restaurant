...
const Order = () => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        const response = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/order/get-all-orders",
          {
            headers: {
  ...
  useEffect(() => {
    const fetchStaffList = async () => {
      ...
      try {
        const response = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/get-all-staff", // Get all staff
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        const kitchenStaffResponse = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/get-all-kitchen-staff", // Get kitchen staff
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleShowDetail = async (orderId) => {
    try {
      ...
      const response = await axios.get(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/order/get-order-by-id/${orderId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
      ...
      await axios.delete(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/order/delete-order/${orderId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
