...
const Payment = () => {
  ...
  useEffect(() => {
    const fetchPromotions = async () => {
      try {
        ...
        const response = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/Promotions/get-all-promotions",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handlePromotionChange = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/Promotions/apply-promotion",
        {
  ...
  const handleCashPaymentConfirm = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/payment/process-payment",
        paymentData,
        {
          headers: {
            "Content-Type": "application/json",
