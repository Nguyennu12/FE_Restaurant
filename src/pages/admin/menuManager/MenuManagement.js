...
const MenuManagement = () => {
  ...
  const fetchMenuItems = async () => {
    try {
      const response = await axios.get(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/menuitem/get-all-menuitems"
      );
  ...
  const handleAddItem = async () => {
    try {
      ...
      const response = await axios.post(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/menuitem/add-new-menuitem",
        newItem,
        {
          headers: {
  ...
  const handleDeleteItem = async (menuItemId) => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      await axios.delete(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/menuitem/delete-menuitem-by-id/${menuItemId}`,
        {
