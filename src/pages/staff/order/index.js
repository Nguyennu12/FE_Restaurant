    ...
    const fetchCustomers = async () => {
      try {
        ...
        const response = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/customer/search-customer?keyword=@",
          {
  ...
  useEffect(() => {
    const fetchKitchenStaff = async () => {
      try {
        ...
        const response = await axios.get(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/get-all-kitchen-staff",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
  ...
  const handleCreateOrder = async (tableId) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/order/create-order",
        orderData,
        {
          headers: {
