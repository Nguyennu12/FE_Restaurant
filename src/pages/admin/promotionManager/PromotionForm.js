...
const PromotionForm = () => {
  ...
  const fetchPromotionDetails = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/promotions/get-detail-promotion/${id}`,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        await axios.put(
          `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/promotions/update-promotion/${id}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("authToken")}`,
        ...
        await axios.post(
          "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/promotions/create-promotion",
          formData,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("authToken")}`,
