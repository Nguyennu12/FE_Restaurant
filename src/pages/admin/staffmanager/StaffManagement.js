...
export default function StaffManagement() {
  ...
  const fetchStaff = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/get-all-staff",
        {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const url = editingStaff
        ? `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/update-staff-by-id/${editingStaff.userId}`
        : "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/create-staff";
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Bạn có chắc chắn muốn xóa nhân viên này?")) {
      try {
        await axios.delete(
          `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/staff/delete-staff-by-id/${id}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
