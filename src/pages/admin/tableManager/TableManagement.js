...
const TableManagement = () => {
  ...
  const fetchTables = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/tables/get-all-table",
  ...
  const handleAddTable = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/tables/create-table",
        {
  ...
  const handleUpdateTable = async () => {
    try {
      ...
      await axios.put(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/tables/update-table/${editingTable.tableId}`,
        {
  ...
  const handleDelete = async (tableId) => {
    try {
      ...
      await axios.delete(
        `https://berestaurantmanagementabc-ckg8cbawb6ducpbk.japanwest-01.azurewebsites.net/api/tables/delete-table/${tableId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
